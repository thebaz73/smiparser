...
public class TypesMibTest extends AbstractMibTestCase {
    ...
    public void testTCMyINTEGER() {
        SmiTextualConvention tc = getMib().getTextualConventions().find(
                "TCMyINTEGER");
    ...
    public void testOTMyINTEGER() {
        ...
        // this one is an exception, because it refers to the INTEGER type
        // directly:
    ...
    public void testOTMyINTEGERFromMinus3To4() {
        SmiObjectType ot = getMib().getVariables().find(
                "myINTEGERFromMinus3To4");
        assertEquals(ot.getId() + " Desc", ot.getDescription());
        assertEquals(ObjectTypeAccessV2.NOT_ACCESSIBLE, ot.getMaxAccess());
        assertEquals(StatusV2.CURRENT, ot.getStatusV2());
    ...
    private void checkMyINTEGERFromMinus3To4(SmiType type) {
        ...
        assertEquals(-3, type.getRangeConstraints().get(0).getMinValue()
                .intValue());
        assertEquals(4, type.getRangeConstraints().get(0).getMaxValue()
                .intValue());
    }
    ...
    private void checkMyInteger32FromMinus5To6(SmiType type) {
        ...
        assertEquals(1, type.getRangeConstraints().size());
        assertEquals(-5, type.getRangeConstraints().get(0).getMinValue()
                .intValue());
        assertEquals(6, type.getRangeConstraints().get(0).getMaxValue()
                .intValue());
    }
    ...
    private void checkMyBits(SmiType type) {
        ...
        assertEquals("one", values.get(1).getId());
        assertEquals(57, values.get(2).getValue().intValue());
        assertEquals("fiftySeven", values.get(2).getId()); // TODO should
        // generate
        // out-of-range here
    }
    ...
    public void testMyDerivedOctetStringBetween3And5() {
        SmiType type = getMib().getTypes().find(
                "MyDerivedOctetStringBetween3And5");
        assertNotNull(type);
    ...
    public void testMyOctetStringBetweenSize9And5() {
        ...
        SmiType type = getMib().getTypes()
                .find("MyOctetStringBetweenSize9And5");
    ...
    public void testTCMyOctetStringBetweenSize9And5() {
        ...
        SmiTextualConvention tc = getMib().getTextualConventions().find(
                "TCMyOctetStringBetweenSize9And5");
        assertEquals(tc.getId() + " Desc", tc.getDescription());
        assertEquals("255a", tc.getDisplayHint());
        assertEquals(StatusV2.DEPRECATED, tc.getStatusV2());
    ...
    private void checkMyCounterFromMinus100To100(SmiType type) {
        ...
        assertEquals(1, type.getRangeConstraints().size());
        assertEquals(-100, type.getRangeConstraints().get(0).getMinValue()
                .intValue()); // TODO test error message:
        assertEquals(100, type.getRangeConstraints().get(0).getMaxValue()
                .intValue());
    }
    ...
    public void testMyUnsigned32() {
        ...
        assertEquals(SmiPrimitiveType.UNSIGNED_32, ot.getType()
                .getPrimitiveType());
    }
    ...
    public void testMyTimeTicks() {
        ...
        assertEquals(SmiPrimitiveType.TIME_TICKS, ot.getType()
                .getPrimitiveType());
    }
